...
namespace nv
{
    ...
    #else
	    if (reinterpret_cast<intptr_t>(ptr) == 0xcccccccc) return false;
	    if (reinterpret_cast<intptr_t>(ptr) == 0xcdcdcdcd) return false;
	    if (reinterpret_cast<intptr_t>(ptr) == 0xdddddddd) return false;
	    if (reinterpret_cast<intptr_t>(ptr) == 0xffffffff) return false;
    #endif
        return true;
    }
